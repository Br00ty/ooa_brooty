...
LOCATION_MAPPING = {
    ...
    [BASE + 89] = {"@Overworld/Nuun Highlands|Symmetry City|Talus Peaks/Symmetry City Main House/Middle Man Trade"},
    ...
    [BASE + 107] = {"@Dungeons/Spirit's Grave (D1)/Wide Room/"},
    [BASE + 108] = {"@Dungeons/Spirit's Grave (D1)/Crystal Room/"},
    [BASE + 109] = {"@Dungeons/Spirit's Grave (D1)/Crossroad/"},
    [BASE + 110] = {"@Dungeons/Spirit's Grave (D1)/West Terrace/"},
    [BASE + 111] = {"@Dungeons/Spirit's Grave (D1)/Pot Chest/"},
    [BASE + 112] = {"@Dungeons/Spirit's Grave (D1)/East Terrace/"},
    [BASE + 113] = {"@Dungeons/Spirit's Grave (D1)/Ghini Drop/"},
    [BASE + 114] = {"@Dungeons/Spirit's Grave (D1)/Basement/"},
    [BASE + 115] = {"@Dungeons/Spirit's Grave (D1)/Pumpkin Head/Boss"},
    -- WING DUNGEON
    [BASE + 116] = {"@Dungeons/Wing Dungeon (D2)/(1F): Color Room/"},
    [BASE + 117] = {"@Dungeons/Wing Dungeon (D2)/(1F): Bombed Terrace/"},
    [BASE + 118] = {"@Dungeons/Wing Dungeon (D2)/(1F): Moblin Platform/"},
    [BASE + 119] = {"@Dungeons/Wing Dungeon (D2)/(1F): Rope Room/"},
    [BASE + 120] = {"@Dungeons/Wing Dungeon (D2)/(1F): Ladder Chest/"},
    [BASE + 121] = {"@Dungeons/Wing Dungeon (D2)/(1F): Moblin Drop/"},
    [BASE + 122] = {"@Dungeons/Wing Dungeon (D2)/(1F): Statue Puzzle/"},
    [BASE + 123] = {"@Dungeons/Wing Dungeon (D2)/(B1F): Thwomp Shelf/"},
    [BASE + 124] = {"@Dungeons/Wing Dungeon (D2)/(B1F): Thwomp Tunnel/"},
    [BASE + 125] = {"@Dungeons/Wing Dungeon (D2)/(B1F): Basement Chest/"},
    [BASE + 126] = {"@Dungeons/Wing Dungeon (D2)/(B1F): Basement Drop/"},
    [BASE + 127] = {"@Dungeons/Wing Dungeon (D2)/Head Thwomp/(1F): Boss"},
 --    MOONLIT GROTTO
    [BASE + 128] = {"@Dungeons/Moonlit Grotto (D3)/(1F): Bridge Chest/"},
    [BASE + 129] = {"@Dungeons/Moonlit Grotto (D3)/(1F): Mimic Room/"},
    [BASE + 130] = {"@Dungeons/Moonlit Grotto (D3)/(1F): Bush Beetle Room/"},
    [BASE + 131] = {"@Dungeons/Moonlit Grotto (D3)/(1F): Crossroad/"},
    [BASE + 132] = {"@Dungeons/Moonlit Grotto (D3)/(1F): Pols Voice Chest/"},
    [BASE + 133] = {"@Dungeons/Moonlit Grotto (D3)/(1F): Armos Drop/"},
    [BASE + 134] = {"@Dungeons/Moonlit Grotto (D3)/(1F): Statue Drop/"},
    [BASE + 135] = {"@Dungeons/Moonlit Grotto (D3)/(1F): Six Blocs Drop/"},
    [BASE + 136] = {"@Dungeons/Moonlit Grotto (D3)/(B1F): Moldorm Drop/"},
    [BASE + 137] = {"@Dungeons/Moonlit Grotto (D3)/(B1F): East/"},
    [BASE + 138] = {"@Dungeons/Moonlit Grotto (D3)/(B1F): Torch Chest/"},
    [BASE + 139] = {"@Dungeons/Moonlit Grotto (D3)/(B1F): Conveyor Belt Room/"},
    [BASE + 140] = {"@Dungeons/Moonlit Grotto (D3)/Shadow Hag/(B1F): Boss"},
--     SKULL DUNGEON
    [BASE + 141] = {"@Dungeons/Skull Dungeon (D4)/(1F): Second Crystal Switch/"},
    [BASE + 142] = {"@Dungeons/Skull Dungeon (D4)/(1F): Lava Pot Chest/"},
    [BASE + 143] = {"@Dungeons/Skull Dungeon (D4)/(1F): Small Floor Puzzle/"},
    [BASE + 144] = {"@Dungeons/Skull Dungeon (D4)/(1F): First Chest/"},
    [BASE + 145] = {"@Dungeons/Skull Dungeon (D4)/(1F): Minecart Chest/"},
    [BASE + 146] = {"@Dungeons/Skull Dungeon (D4)/(1F): Cube Chest/"},
    [BASE + 147] = {"@Dungeons/Skull Dungeon (D4)/(1F): First Crystal Switch/"},
    [BASE + 148] = {"@Dungeons/Skull Dungeon (D4)/(1F): Color Tile Drop/"},
    [BASE + 149] = {"@Dungeons/Skull Dungeon (D4)/(B1F): Large Floor Puzzle/"},
    [BASE + 150] = {"@Dungeons/Skull Dungeon (D4)/Eyesoar/(B1F): Boss"},
    -- CROWN DNGEON
    [BASE + 151] = {"@Dungeons/Crown Dungeon (D5)/(1F): Diamond Chest/"},
    [BASE + 152] = {"@Dungeons/Crown Dungeon (D5)/(1F): Eyes Chest/"},
    [BASE + 153] = {"@Dungeons/Crown Dungeon (D5)/(1F): Three-Statue Puzzle/"},
    [BASE + 154] = {"@Dungeons/Crown Dungeon (D5)/(1F): Blue Peg Chest/"},
    [BASE + 155] = {"@Dungeons/Crown Dungeon (D5)/(B1F): Like-Like Chest/"},
    [BASE + 156] = {"@Dungeons/Crown Dungeon (D5)/(B1F): Red Peg Chest/"},
    [BASE + 157] = {"@Dungeons/Crown Dungeon (D5)/(B1F): Owl Puzzle/"},
    [BASE + 158] = {"@Dungeons/Crown Dungeon (D5)/(B1F): Two-Statue Puzzle/"},
    [BASE + 159] = {"@Dungeons/Crown Dungeon (D5)/(B1F): Dark Room/"},
    [BASE + 160] = {"@Dungeons/Crown Dungeon (D5)/(B1F): Six-Statue Puzzle/"},
    [BASE + 161] = {"@Dungeons/Crown Dungeon (D5)/Smog/(1F): Boss"},
    -- MERMAIDS CAVE PRESENT
    [BASE + 162] = {"@Dungeons/Mermaid's Cave [Present] (D6)/Vire Chest/"},
    [BASE + 163] = {"@Dungeons/Mermaid's Cave [Present] (D6)/Spinner Chest/"},
    [BASE + 164] = {"@Dungeons/Mermaid's Cave [Present] (D6)/Rope Chest/"},
    [BASE + 165] = {"@Dungeons/Mermaid's Cave [Present] (D6)/RNG Chest/"},
    [BASE + 166] = {"@Dungeons/Mermaid's Cave [Present] (D6)/Diamond Chest/"},
    [BASE + 167] = {"@Dungeons/Mermaid's Cave [Present] (D6)/Beamos Chest/"},
    [BASE + 168] = {"@Dungeons/Mermaid's Cave [Present] (D6)/Cube Chest/"},
    [BASE + 169] = {"@Dungeons/Mermaid's Cave [Present] (D6)/Channel Chest/"},
    -- MERMAIDS CAVE PAST
    [BASE + 170] = {"@Dungeons/Mermaid's Cave [Past] (D6)/(1F): Stalfos Chest/"},
    [BASE + 171] = {"@Dungeons/Mermaid's Cave [Past] (D6)/(1F): Color Room/"},
    [BASE + 172] = {"@Dungeons/Mermaid's Cave [Past] (D6)/(1F): Pool Chest/"},
    [BASE + 173] = {"@Dungeons/Mermaid's Cave [Past] (D6)/(1F): Wizzrobe/"},
    [BASE + 174] = {"@Dungeons/Mermaid's Cave [Past] (D6)/(B1F): Diamond Chest/"},
    [BASE + 175] = {"@Dungeons/Mermaid's Cave [Past] (D6)/(B1F): Spear Chest/"},
    [BASE + 176] = {"@Dungeons/Mermaid's Cave [Past] (D6)/(B1F): Rope Chest/"},
    [BASE + 177] = {"@Dungeons/Mermaid's Cave [Past] (D6)/Octogon/(1F): Boss"},
    -- JABU-JABUS BELLY
    [BASE + 178] = {"@Dungeons/Jabu-Jabu's Belly (D7)/(1F): Island Chest/"},
    [BASE + 179] = {"@Dungeons/Jabu-Jabu's Belly (D7)/(1F): Stairway Chest/"},
    [BASE + 180] = {"@Dungeons/Jabu-Jabu's Belly (D7)/(1F): Miniboss Chest/"},
    [BASE + 181] = {"@Dungeons/Jabu-Jabu's Belly (D7)/(1F): Cane|Diamond Puzzle/"},
    [BASE + 182] = {"@Dungeons/Jabu-Jabu's Belly (D7)/(1F): Boxed Chest/"},
    [BASE + 183] = {"@Dungeons/Jabu-Jabu's Belly (D7)/(1F): Flower Room/"},
    [BASE + 184] = {"@Dungeons/Jabu-Jabu's Belly (D7)/(1F): Diamond Puzzle/"},
    [BASE + 185] = {"@Dungeons/Jabu-Jabu's Belly (D7)/(1F): Crab Chest/"},
    [BASE + 186] = {"@Dungeons/Jabu-Jabu's Belly (D7)/(2F): Left Wing/"},
    [BASE + 187] = {"@Dungeons/Jabu-Jabu's Belly (D7)/(2F): Right Wing/"},
    [BASE + 188] = {"@Dungeons/Jabu-Jabu's Belly (D7)/(2F): Spike Chest/"},
    [BASE + 189] = {"@Dungeons/Jabu-Jabu's Belly (D7)/(3F): Hallway Chest/"},
    [BASE + 190] = {"@Dungeons/Jabu-Jabu's Belly (D7)/(3F): Post-Hallway Chest/"},
    [BASE + 191] = {"@Dungeons/Jabu-Jabu's Belly (D7)/(3F): Terrace/"},
    [BASE + 192] = {"@Dungeons/Jabu-Jabu's Belly (D7)/Plasmarine/(2F): Boss"},
    -- ANCIENT TOMB
    [BASE + 193] = {"@Dungeons/Ancient Tomb (D8)/(1F): Single Chest/"},
    [BASE + 194] = {"@Dungeons/Ancient Tomb (D8)/(B2F): Maze Chest/"},
    [BASE + 195] = {"@Dungeons/Ancient Tomb (D8)/(B2F): NW Slate Chest/"},
    [BASE + 196] = {"@Dungeons/Ancient Tomb (D8)/(B2F): NE Slate Chest/"},
    [BASE + 197] = {"@Dungeons/Ancient Tomb (D8)/(B2F): Ghini Chest/"},
    [BASE + 198] = {"@Dungeons/Ancient Tomb (D8)/(B2F): SE Slate Chest/"},
    [BASE + 199] = {"@Dungeons/Ancient Tomb (D8)/(B2F): SW Slate Chest/"},
    [BASE + 200] = {"@Dungeons/Ancient Tomb (D8)/(B1F): NW Chest/"},
    [BASE + 201] = {"@Dungeons/Ancient Tomb (D8)/(B1F): Sarcophagus Chest/"},
    [BASE + 202] = {"@Dungeons/Ancient Tomb (D8)/(B1F): Blade Trap/"},
    [BASE + 203] = {"@Dungeons/Ancient Tomb (D8)/(B1F): Blue Peg Chest/"},
    [BASE + 204] = {"@Dungeons/Ancient Tomb (D8)/(B1F): Floor Puzzle/"},
    [BASE + 205] = {"@Dungeons/Ancient Tomb (D8)/(B2F): Tile Room/"},
    [BASE + 206] = {"@Dungeons/Ancient Tomb (D8)/(B1F): Stalfos/"},
    [BASE + 207] = {"@Dungeons/Ancient Tomb (D8)/(B3F): Single Chest/"},
    [BASE + 208] = {"@Dungeons/Ancient Tomb (D8)/Ramrock/(B3F): Boss"},
    -- ESSENCES
    [BASE + 209] = {"@Dungeons/Spirit's Grave (D1)/Eternal Spirit/Essence"},
    [BASE + 210] = {"@Dungeons/Wing Dungeon (D2)/Ancient Wood/Essence"},
    [BASE + 211] = {"@Dungeons/Moonlit Grotto (D3)/Echoing Howl/Essence"},
    [BASE + 212] = {"@Dungeons/Skull Dungeon (D4)/Burning Flame/Essence"},
    [BASE + 213] = {"@Dungeons/Crown Dungeon (D5)/Sacred Soil/Essence"},
    [BASE + 214] = {"@Dungeons/Mermaid's Cave [Past] (D6)/Lonely Peak/Essence"},
    [BASE + 215] = {"@Dungeons/Jabu-Jabu's Belly (D7)/Rolling Sea/Essence"},
    [BASE + 216] = {"@Dungeons/Ancient Tomb (D8)/Falling Star/Essence"},
    -- SEED TREES
