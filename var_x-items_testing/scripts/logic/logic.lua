...
function target_carts_shooter()
  return (shooter() and (pegasus() or ember() or mystery() or scent()))
end

function target_carts_slingshot()
  return (slingshot2() and (pegasus() or ember() or mystery() or scent()))
end
